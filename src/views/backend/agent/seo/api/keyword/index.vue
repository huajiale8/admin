...
import {agentSeoApiKeywordDetail, agentSeoApiKeywordList} from "/@/api/backend/agent/seo/api/keyword/keyword";
import BtnRefresh from "/@/components/buttons/BtnRefresh.vue";
import BtnSearch from "/@/components/buttons/BtnSearch.vue";
import PopupForm from "/@/views/backend/agent/seo/api/keyword/popupForm.vue";
...
const operation = (id: number) => {
    agentSeoApiKeywordDetail({id: id}).then(res => {
...
const getList = () => {
    pageInfo.status = activeName.value
    loading.value = true
    agentSeoApiKeywordList(pageInfo).then(res => {
