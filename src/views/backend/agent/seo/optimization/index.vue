...
import {agentSupplierList} from "/@/api/backend/agent/seo/checklist/checklist";
import {
    agentSeoKeyquery,
    agentSeoKeywordTask,
    agentSeoOptimizationList,
    agentSeoOptimizationLists
} from "/@/api/backend/agent/seo/optimization/optimization";
...
const getList = () => {
    loading.value = true
    agentSeoOptimizationList(pageInfo).then(res => {
...
const SupplierList = () => {
    agentSupplierList(pageInfo).then(res => {
...
const derive = () => {
    ...
    agentSeoOptimizationList(pageInfo).then(res => {
        ...
        if (arr.length > 0) {
            ...
            agentSeoOptimizationLists(pageInfo).then(res => {
