...
import {agentSeoKeywordDetail, agentSeoKeywordList} from "/@/api/backend/agent/seo/checklist/checklist";
...
import PopupForm from "/@/views/backend/agent/seo/keyword/popupForm.vue";
...
const getList = () => {
    ...
    loading.value = true
    agentSeoKeywordList(pageInfo).then(res => {
...
const operation = (id: number) => {
    agentSeoKeywordDetail({id: id}).then(res => {
