...
import {exportLogList} from "/@/api/backend/order/log";
...
const refreshList = (query?: Query) => {
    ...
    exportLogList(query || queryInfo.value).then(res => {
    ...
    <div class="default-main ba-table-box">
        <el-card>
            ...
            <el-table v-loading="tableLoading" :data="log_list" border fit>
                ...
                <el-table-column label="导出数量" prop="num" align="center" width="150"/>
                ...
                <el-table-column
                    ...
                    :show-overflow-tooltip="true"
                    align="center"/>
                <el-table-column label="出错原因" align="center" width="120">
                    <template #default="scope">
                        <el-popover
                ...
                <el-table-column label="下载地址" fixed="right" align="center" width="120">
                    <template #default="scope">
                        <el-link v-if="scope.row.file" :href="scope.row.file" target="_blank" type="primary">下载
                        </el-link>
                    </template>
                </el-table-column>
            </el-table>
