...
import PopupForm from "/@/views/backend/identityi/panorama/popupForm.vue";
import PagingModule from "/@/components/custom/ModPagingModule.vue";
import {panoramaDetail, panoramaLists} from "/@/api/backend/auth/identityi/panorama";
