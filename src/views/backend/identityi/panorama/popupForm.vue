        ...
        <el-scrollbar max-height="60vh">
            <div class="ba-operate-form">
                ...
                >
                    ...
                    <el-descriptions-item label="摄影器材型号"  min-width="130px" :span="1" label-align="center">
                    ...
                    <el-descriptions-item
                        ...
                        {{ store.bankList.intro }}
                    </el-descriptions-item>
                    <el-descriptions-item label="作品案列" label-align="center" :span="3">
...
import {panoramaPass, panoramaReject} from "/@/api/backend/auth/identityi/panorama";
import {panoramaConfig} from "/@/stores/identity/panoramapupForm";
import {auth} from "/@/utils/common";

const store = panoramaConfig()
const reject = () => {
    ElMessageBox.prompt("请输入驳回理由", "驳回", {
        ...
        .then(({value}) => {
            panoramaReject({id: store.id, reason: value}).then(() => {
