                ...
                <el-table-column
                    ...
                    <template #default="scope">
                            <el-image
                                ...
                                :preview-src-list="[scope.row.origin]"
                                style="width: 30px; height: 30px"
                                :src="scope.row.origin"
                                :initial-index="4"
                                fit="cover"
                            />
                    </template>
...
import {disable, enable, pictureLists} from "/@/api/backend/portal/source/picture";
